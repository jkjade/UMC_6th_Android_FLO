...
//    }
    ...
    inner class ViewHolder(val binding: ItemSongBinding): RecyclerView.ViewHolder(binding.root){
        fun bind(song: Song){
            binding.itemSongAlbumTitleTv.text = song.title
            binding.itemSongAlbumSingerTv.text = song.singer
            binding.itemSongAlbumCoverImgIv.setImageResource(song.coverImg!!)
        }
    }
}